...
def split_meme_and_cutoff_files(meme_file_path, cutoffs_file_path, motifs_per_file, done_path, argv='no_argv'):
    ...
    if cutoffs_file_path:
        verify_file_is_not_empty(cutoffs_file_path)

    message = f'{datetime.datetime.now()}: splitting '
    ...
    if meme_file_path:
        message += splitted_meme_dir
    
    if cutoffs_file_path:
        if meme_file_path: message += '\n'
        message += splitted_cutoffs_dir
...
if __name__ == '__main__':
    ...
    meme_file_path = None if args.meme_file_path.lower() == 'skip' else args.meme_file_path
    cutoffs_file_path = None if args.cutoffs_file_path.lower() == 'skip' else args.cutoffs_file_path

    split_meme_and_cutoff_files(meme_file_path, cutoffs_file_path, args.motifs_per_file,
