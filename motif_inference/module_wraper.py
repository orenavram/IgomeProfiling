...
def infer_motifs(first_phase_output_path, motif_inference_output_path, logs_dir, samplename2biologicalcondition_path,
                 ...
                 threshold, word_length, discard, algorithm_mode, concurrent_cutoffs, meme_split_size, skip_sample_merge_meme,
    ...
    for no_cys_faa_path in no_cys_faa_paths:
        ...
        if not os.path.exists(done_path):
            cmds = [no_cys_faa_path, output_prefix, done_path , sample_name, '--threshold', threshold, '--word_length', word_length, '--discard', discard, '--algorithm_mode', algorithm_mode]
...
if __name__ == '__main__':
    ...
    infer_motifs(args.parsed_fastq_results, args.motif_inference_results, args.logs_dir, args.samplename2biologicalcondition_path,args.max_msas_per_sample,
                 ...
                 args.word_length, args.discard, args.algorithm_mode, concurrent_cutoffs, args.meme_split_size, args.skip_sample_merge_meme, 
