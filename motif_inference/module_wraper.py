...
map_names_command_line = {
    ...
    "min_library_lenght_cutoff": "min_library_lenght_cutoff",
    "max_library_lenght_cutoff": "max_library_lenght_cutoff",
...
def compute_cutoffs_then_split(biological_conditions, meme_split_size, cutoff_random_peptitdes_percentile, min_library_lenght_cutoff, max_library_lenght_cutoff,
    ...
    for bc in biological_conditions:
        ...
        if not os.path.exists(done_path):
            all_cmds_params.append([meme_path, output_path, done_path, '--total_memes', 0, '--cutoff_random_peptitdes_percentile', cutoff_random_peptitdes_percentile,
                                    '--min_library_lenght_cutoff', min_library_lenght_cutoff, '--max_library_lenght_cutoff', max_library_lenght_cutoff])
        else:
...
def split_then_compute_cutoffs(biological_conditions, meme_split_size, cutoff_random_peptitdes_percentile, min_library_lenght_cutoff, max_library_lenght_cutoff,
    motif_inference_output_path, logs_dir, queue_name, error_path, verbose):
...
def infer_motifs(reads_path, motifs_path, logs_dir, sample2bc,
                 ...
                 min_library_lenght_cutoff, max_library_lenght_cutoff, queue, verbose, mapitope, error_path, exp_name, argv):
    ...
    if concurrent_cutoffs:
        split_then_compute_cutoffs(biological_conditions, meme_split_size, cutoff_random_peptitdes_percentile, min_library_lenght_cutoff, max_library_lenght_cutoff,
            motifs_path, logs_dir, queue, error_path, verbose)
    else:
        compute_cutoffs_then_split(biological_conditions, meme_split_size, cutoff_random_peptitdes_percentile, min_library_lenght_cutoff, max_library_lenght_cutoff,
            motifs_path, logs_dir, queue, error_path, verbose)
