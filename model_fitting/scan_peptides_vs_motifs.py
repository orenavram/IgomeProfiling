...
def calculate_pssm_thresholds(meme_path, cutoffs_path, faa_path, number_of_random_pssms, 
                              shuffles, shuffles_percent, shufles_digits, output_path, done_path, rank_method, argv='no_argv',
    ...
    if not os.path.exists(output_path):
        ...
        if rank_method == 'pval':
            ...
            cmd = f'./hits_cpp/hits -m {meme_path} -c {cutoffs_path} -s {faa_path} -o {output_path} --shuffles {shuffles} --shufflesPercent {shuffles_percent} --shuflesDigits {shufles_digits}'
...
if __name__ == '__main__':
    ...
    calculate_pssm_thresholds(args.meme_file_path, args.cutoffs_file_path, args.faa_file_path,
                              args.number_of_random_pssms, args.shuffles, args.shuffles_percent, args.shufles_digits,args.output_path, 
